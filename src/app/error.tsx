    ...
    <main className="lumina-fallback mx-auto flex min-h-[70vh] w-full max-w-3xl flex-col items-center justify-center px-5 text-center sm:px-8">
      ...
      <div className="mt-8 flex flex-wrap justify-center gap-3">
        <button
          ...
          className="theme-control bg-hobun px-5 py-2.5 text-sm font-medium text-ink-900"
        >
          {t("retry")}
        </button>
        <Link href="/" className="theme-control border border-ink-700 px-5 py-2.5 text-sm text-hobun">
          {t("home")}
        </Link>
      </div>
    </main>
