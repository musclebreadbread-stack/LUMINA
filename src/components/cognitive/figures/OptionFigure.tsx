import { MatrixOptionCell } from "./MatrixOptionCell";
...
export function OptionFigure({ figure, label, idPrefix, maxWidth, className }: OptionFigureProps) {
  if (figure.kind === "matrix") {
    return <MatrixOptionCell figure={figure} label={label} idPrefix={idPrefix} maxWidth={maxWidth} className={className} />;
  }
